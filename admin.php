...
$dessertsSQL = "SELECT productID, productName, productPrice, productImage FROM products WHERE productCategory='2'";
$dessertsQuery = mysqli_query($con, $dessertsSQL);

$foodSQL = "SELECT * FROM products WHERE productCategory='1'";
...
<body>
  <div class="nav">
    <ul>
      ...
      <li><a href="#" class="nav-link">Edite</a></li>
    </ul>
  </div>
    <div class="global">
...
while($dessertsResults = mysqli_fetch_assoc($dessertsQuery)){
    ...
    <h4 class="prix">'.$dessertsResults["productPrice"].' DH</h4>
    <div class="UD">
    <button class="update"> <a href="traitement.php?idfood='.$dessertsResults["productID"].'">Update </a> </button>
     <button class="update"><a href="delete.php?idfood='.$dessertsResults["productID"].'">Delete </a></button>
      </div>
    </div>
    </div>';
}
?> 
        ...
        <div class="right">
          ...
          <h4 class="prix">'.$foodResults["productPrice"].' DH</h4>
          <div class="UD">
          <button class="update"> <a  href="traitement.php?idfood='.$foodResults["productID"].'">Update </a> </button>
          <button class="update"> <a  href="delete.php?idfood='.$foodResults["productID"].'">Delete </a> </button> 
          </div>
          </div>
          </div>';
